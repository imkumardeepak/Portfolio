      ...
      <div className="flex flex-col items-center justify-center w-full">
        <div className="flex flex-col items-center justify-center w-full gap-5 mb-8 lg:flex-row">
          ...
          >
            ...
            >
              <h6 className="text-base font-medium text-white">Email</h6>
          ...
          >
            <Button
              ...
              className="flex-col items-start w-full h-auto p-5 hover:scale-100"
            >
              <h6 className="text-base font-medium text-white">Phone</h6>
              <p className="mt-2 text-base text-neutral-300">+91 8409671140</p>
            </Button>
          </Link>
        </div>
